...
@WebServlet("/editScreen1")
public class EditScreenServletAdminForWorkers extends HttpServlet {
    private static final String query = "SELECT name, type, email, password FROM worker_bank WHERE id = ?";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql:///banksys", "root", "ExecuteOrder66");
            ...
            resultSet.next();
            out.println("<form action='editUrl1?id=" + id + "' method='post'>");
            ...
            out.println("<tr>");
            out.println("<td style='border: 6px solid black; color: red;'>Статус</td>");
            ...
            out.println("<td style='border: 6px solid black; color: red;'><input type='text' name='personPassword' value='" + resultSet.getString(4) +"'></td>");
            out.println("</tr>");
