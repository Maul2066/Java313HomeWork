...
<form action="loginUser" method="post">
    <div style="border: solid black 5px; width: 450px; background-color: black; height: 450px; border: solid red; border-radius: 10px; margin-top: 50px; margin-left: 500px;">
        <h2 style="text-align: center; color: white;">Авторизация пользователя</h2>
        ...
        <button style="border: solid white 5px; border-radius: 5px; background-color: #b02424; font-weight: bold; font-family: 'Cooper Black'; width: 200px; height: 50px; margin-top: 80px; margin-left: 120px" >ВОЙТИ</button> <br> <br>
        <div style="color: white; text-align: center;">У вас нет аккаунта? <a style="color: red" href="registerUser.jsp">Создать аккаунт</a></div>
    </div>
</form>
